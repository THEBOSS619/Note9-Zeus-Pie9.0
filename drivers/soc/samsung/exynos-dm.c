...
show_voltage_table(DM_FSYS0, dm_fsys0);
show_voltage_table(DM_CAM, dm_cam);
show_voltage_table(DM_DISP, dm_disp);
show_voltage_table(DM_AUD, dm_aud);
show_voltage_table(DM_IVA, dm_iva);
show_voltage_table(DM_SCORE, dm_score);
...
static DEVICE_ATTR(voltage_table_dm_fsys0, 0440, show_voltage_table_dm_fsys0, NULL);
...
static DEVICE_ATTR(voltage_table_dm_iva, 0440, show_voltage_table_dm_iva, NULL);
static DEVICE_ATTR(voltage_table_dm_score, 0440, show_voltage_table_dm_score, NULL);
...
static struct attribute *exynos_dm_sysfs_entries[] = {
	...
	&dev_attr_voltage_table_dm_fsys0.attr,
	&dev_attr_voltage_table_dm_cam.attr,
	&dev_attr_voltage_table_dm_disp.attr,
	&dev_attr_voltage_table_dm_aud.attr,
	&dev_attr_voltage_table_dm_iva.attr,
	&dev_attr_voltage_table_dm_score.attr,
